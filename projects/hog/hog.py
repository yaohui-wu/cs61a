...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def num_rolls(player_score, opponent_score):
        return n
    return num_rolls
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while player_score < goal:
        while opponent_score < goal:
            ...
            opponent_score += 1
            new_num_rolls = strategy(player_score, opponent_score)
            if num_rolls != new_num_rolls:
                return False
        player_score += 1
        opponent_score = 0
    return True
...
def make_averaged(original_function, samples_count=1000):
    ...
    def average(*args):
        ...
        while i <= samples_count:
            ...
            total += n
            i += 1
        avg = total / samples_count # Average.
        return avg
    return average
    # END PROBLEM 8
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    points = boar_brawl(score, opponent_score)
    points += sus_points(score + points) - score
    if points >= threshold:
        return 0
    return num_rolls
    # END PROBLEM 11
